  ...
  return (
    <div className="flex flex-col gap-5 w-full">
     <div className="flex bg-white shadow-md p-3 rounded-md justify-between items-center w-full ">
      <span className="font-comic font-bold text-2xl text-dark-blue">{PRODUCT_SCREEN}</span>
      <div className="flex gap-5">
        <input className="rounded-full min-w-[240] px-5 outline-none border border-input-border" placeholder="Search products" />
